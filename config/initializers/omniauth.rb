...
OMNIAUTH_GITHUB_KEYS["colognerb.de"]       = [ENV['GITHUB_COLOGNERB_CONSUMER_KEY'], ENV['GITHUB_COLOGNERB_CONSUMER_SECRET']]
OMNIAUTH_GITHUB_KEYS["www.colognerb.de"]   = [ENV['GITHUB_COLOGNERB_CONSUMER_KEY'], ENV['GITHUB_COLOGNERB_CONSUMER_SECRET']]
